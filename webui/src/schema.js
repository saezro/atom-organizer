...
export const AEROTOOLS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'aerotools_max_error', type: 'number', label: 'Máx. imágenes con giro distinto (%)', default: '0' },
      { name: 'aerotools_add_to_angle', type: 'number', label: 'Margen Yaw + (grados)', default: '0' },
      { name: 'aerotools_subs_to_angle', type: 'number', label: 'Margen Yaw − (grados)', default: '0' },
    ],
  },
  {
...
export const OTROS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'max_error', type: 'number', label: 'Máx. imágenes con giro distinto (%)', default: '0' },
      { name: 'add_to_angle', type: 'number', label: 'Margen Yaw + (grados)', default: '0' },
      { name: 'subs_to_angle', type: 'number', label: 'Margen Yaw − (grados)', default: '0' },
    ],
  },
  {
    task: 'rename_images',
...
export const SPLIT_ADVANCED = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'gen_thumbnails_max_error', type: 'number', label: 'Máx. imágenes con giro distinto (%)', default: '0' },
      { name: 'gen_thumbnails_add_to_angle', type: 'number', label: 'Margen Yaw + (grados)', default: '0' },
      { name: 'gen_thumbnails_subs_to_angle', type: 'number', label: 'Margen Yaw − (grados)', default: '0' },
    ],
  },
  {
